 ...
 * Blob Hash: $Id: e56f64b5b4897327c94c60ce24f3597770b8a681 $
...
{
    require_once("custom/src/libraries/PSLog.php");
}
...
{    
    ...
    {
        return call_user_func_array(sprintf("PSLog::%s", $name), $arguments);
    }
