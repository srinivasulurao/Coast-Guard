        ...
        <div id="rn_SearchControls">
            ...
            <form method="post" action="" onsubmit="return false" >
                <div class="rn_SearchInput">
                    <rn:widget path="search/AdvancedSearchDialog" report_id="176" display_sort_filter="false"/>
				...
				<!-- begin dotp2012jp fix -->
				<div style="position: absolute; width: 320px; top: -10px; left: 550px; font-size: 0.8em;">
				</div>
				<!-- end dotp2012jp fix -->
            </form>
