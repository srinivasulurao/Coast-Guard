...
*/
 ...
 $rnHooks['pre_incident_create'][] = array(
       'class' => 'Preincidentcreate_model',
       'function' => 'Append_CF2Q',
       'filepath' => ''
   );

 $rnHooks['pre_pta_decode'][] = array(
        'class' => 'Preptaloginmy_model',
        'function' => 'decodeptaloginmy',
        'filepath' => ''
    );

$rnHooks['pre_pta_convert'][] = array(
        'class' => 'PrePtaConvertRemoveFields_model',
        'function' => 'removeNonRequiredFields',
        'filepath' => ''
    );
