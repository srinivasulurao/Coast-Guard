...
class soap_transport_http extends nusoap_base {
	...
	*/
	...
	function connect($connection_timeout=10,$response_timeout=30){
...
class soapclient extends nusoap_base  {
	...
	*/
	function call($operation,$params=array(),$namespace='http://tempuri.org',$soapAction='',$headers=false,$rpcParams=null,$style='rpc',$use='encoded'){
        ...
        $this->debug("LDAVISON - soap_msg[$soapmsg]\n");
		...
		switch(true){
			...
			case ereg('^http',$this->endpoint):
				...
				//} elseif(strpos($this->endpoint,'https:')){
					...
					//} else
				  $msg = str_replace('ValidateSessionRequest xmlns=""', 'ValidateSessionRequest xmlns="http://soe.sony.com/gateway/rightnow"', $msg);
