    ...
    <div id="rn_SearchControls">
        ...
        <form method="post" action="" onsubmit="return false" >
                <div class="rn_SearchInput">
                    <rn:widget path="search/AdvancedSearchDialog" report_id="159" display_categories_filter="false"/>
                    <rn:widget path="search/KeywordText2" label_text="#rn:msg:SEARCH_YOUR_SUPPORT_HISTORY_CMD#" report_id="159" initial_focus="true" label_placeholder=""/>
                </div>
...
<div id="rn_PageContent" class="rn_QuestionList">
    <div class="rn_Padding">
        ...
        <rn:widget path="reports/Grid2" label_caption="#rn:msg:SUPPORT_HISTORY_LBL#" report_id="159" hide_when_no_results="true"/>
