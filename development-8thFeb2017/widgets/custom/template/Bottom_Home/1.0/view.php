	...
	<div id="divFooterBar">
		<div id="divFooter">
			...
			<div id="divFooterContent">
				...
				<div id="divFooterContentCopyright">&copy; 1995-2017 Wizards of the Coast LLC, a subsidiary of Hasbro, Inc. All Rights Reserved.</div>
			</div>
			<div id="divFooterRightIcons">
				...
				<div id="divESRBIcon">
					<a href="https://www.esrb.org/confirm/wizards-confirmation.jsp" target="_blank"id="aESRBLink"><img src="/euf/assets/images/ESRB_icon.gif" width="57px" height="76px" border="0"></a>
				</div>
			</div>
			<div id="divLinearGradient">&nbsp;</div>
		</div>	
		<div>
			<script language="JavaScript" src="https://www.wizards.com/global/hbx_onpage_standard.js" type="text/javascript"></script>
			<script language="javascript1.1" src="https://www.wizards.com/global/hbx.js" type="text/javascript"></script>
			<noscript>
