...
for($i=0; $i<count($this->data['fields']); $i++): 
	if($this->data['fields']['cf_item'.$i]['cf_id'] != 44 && $this->data['fields']['cf_item'.$i]['cf_id'] != 53 && $this->data['fields']['cf_item'.$i]['value']!='' && $this->data['fields']['cf_item'.$i]['value']!=NULL && $this->data['fields']['cf_item'.$i]['value']!==0 && $this->data['fields']['cf_item'.$i]['value']!='0'){
?>
