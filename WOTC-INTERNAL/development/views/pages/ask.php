...
<div id="rn_PageContent" class="rn_PageContent rn_AskQuestion rn_Container">
  <div class="rn_Padding css-hint">
    <form id="rn_QuestionSubmit" method="post" action="/cc/ajaxDyn/save_aaq_form_data" >
      ...
      <rn:widget path="custom/dynamicForms/DynamicProductCategory" table="incidents" name="Incident.Category" label_input="#rn:msg:CATEGORY_LBL#" label_nothing_selected="#rn:msg:SELECT_A_CATEGORY_LBL#"  />
      <rn:widget path="custom/dynamicForms/DynamicProductCategory"  table="incidents" name="Incident.Product" label_input="#rn:msg:PRODUCTS_LBL#" label_nothing_selected="#rn:msg:SELECT_A_PRODUCT_LBL#" required_lvl="2" label_required="Additional sub product is required. Please select additional product under %s"/>
      ...
      <rn:widget path="input/TextInput" name="incidents.Subject" required="true" /><br>
      <div class="imp-msg" > <em>IMPORTANT!:  To ensure security of your personal financial information, please DO NOT submit sensitive financial data via this form; this includes complete credit card numbers and/or bank account information.</em><br />
      </div>
      ...
      <input type='hidden' id='form_enabled_data' name="form_enabled_data" value="">
      <input type='hidden' id='form_category' name="form_category" value="<?php echo (int)getUrlParm('c'); ?>">
      <input type='hidden' id='form_product' name="form_product" value="<?php echo (int)getUrlParm('p'); ?>">
      </div>
