...
<div id="rn_PageContent" class="rn_Profile">
    <div class="rn_Padding">
        ...
        <form id="rn_CreateAccount" method="post" action="" onsubmit="return false;">
            ...
            <rn:widget path="input/ProductCategoryInput" required="true" required_lvl="2" table="contacts" label_input="#rn:msg:DEFAULT_PROD_LBL#" label_nothing_selected="" allow_external_login_updates="true"/>
            <rn:widget path="input/ProductCategoryInput" required="true" required_lvl="1" table="contacts" data_type="categories" label_input="#rn:msg:DEFAULT_CAT_LBL#" label_nothing_selected=""  allow_external_login_updates="true"/>
            ...
            <fieldset>
                ...
                <rn:widget path="input/FormInput" name="contacts.login" required="true" validate_on_blur="true" initial_focus="true" label_username="#rn:msg:USER_ID_LBL#"  allow_external_login_updates="true" read_only ="true" style="text-decoration:none;"/>
            </fieldset>
            ...
            <fieldset>
				...
				*/ ?>
                ...
                <rn:widget path="input/FormInput" name="contacts.email_alt1"  allow_external_login_updates="true"/>
                <rn:widget path="input/FormInput" name="contacts.email_alt2"  allow_external_login_updates="true"/>
