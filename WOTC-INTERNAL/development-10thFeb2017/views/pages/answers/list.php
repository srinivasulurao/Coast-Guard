<rn:meta title="#rn:msg:FIND_ANS_HDG#" template="standard.php" clickstream="answer_list" use_profile_defaults="true"  sla_required_type="selfservice"/>
...
<div id="rn_PageTitle" class="rn_AnswerList">
    <rn:condition is_spider="false">
        <div id="rn_SearchControls">
            ...
            <rn:widget path="search/DisplaySearchFilters" report_id="176" show_filter_label="true"/>
        </div>
    </rn:condition>
</div>
<div id="rn_PageContent" class="rn_AnswerList">
    <div class="rn_Padding">
        ...
        <rn:widget path="reports/Multiline2" report_id="176" hide_columns="answers.updated"/>
